...
local resourceName = "hw_whitewidow"
    ...
    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_whitewidow" then
            resourceName = "hw_whitewidow (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_whitewidow/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_whitewidow/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_whitewidow"
